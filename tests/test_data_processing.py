...
class TestDataProcessingPipeline(unittest.TestCase):
    ...
    def test_match_summaries_structure(self):
        ...
        # Check key columns
        expected_columns = ["match_id", "venue", "teams", "outcome_winner"]
...
class TestDataQuality(unittest.TestCase):
    ...
    def test_no_null_critical_fields(self):
        ...
        for field in critical_fields:
            if field in df.columns:
                ...
                self.assertEqual(null_count, 0, f"Field '{field}' should not have null values")
    ...
    def test_runs_are_reasonable(self):
        ...
        self.assertGreaterEqual(df["runs_batter"].min(), 0, "Minimum runs should be 0")
